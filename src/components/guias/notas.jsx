...
export const Notas = () => {
    return (
        <table id="table-notas">
            ...
            <tr>
                <td>
                    2. ESTA GUÍA SERA VÁLIDA DURANTE 72HR A PARTIR DE LA FECHA DE LA MISMA EN EL TRAYECTO ESTIPULADO. CUALQUIER VARIACIÓN DE ESTOS VALORES DEBERÁN SER NOTIFICADOS DE MANERA INMEDIATA AL ENTE RECTOR.
                </td>
            </tr>
            <tr>
                <td>
